<template>
    ...
    <div id="finishedTea">
        <div class="container">
            ...
            <div class="nav-top">您当前的位置：<router-link to="/">首页</router-link>>>成品茶介绍页</div>
            <v-md-preview class="introduce-body">
                <div id="tea-product">
                    <div class="items">
                        <img class="tea-img" :src="'../'+content.img" alt="暂无图片">
                        <div class="item">
                            <div class="item-title">{{ content.finishTeaName }}</div>
                            <div class="item-txt">{{ content.introduction }}</div>
                            <div class="item-link">
                                <div class="links">
                                    <div class="link-item" v-for="iteminfo of axList.slice(1,7)">
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            //主体内容
            instance1.get(`/tea/product/get/${this.id}`).then(res => {
